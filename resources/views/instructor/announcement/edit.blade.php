        ...
        <div class="row">
            <div class="col-lg-12">
                <nav class="breadcrumb">
                    ...
                    <a class="breadcrumb-item" href="{{route('instructor.announcement.index', $course->id)}}">Announcement</a>
                </nav>
            </div>
        </div>
            ...
            <div class="col-xl-6 col-md-6 mb-5 pb-5">
                ...
                <div class="card card-cascade narrower z-depth-1">
                    <div class="view gradient-card-header indigo narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                            <a class="white-text mx-3">Update Announcement</a>
                        <div>
                            <a href="{{route('instructor.announcement.index', $course->id)}}" class="btn btn-outline-white btn-rounded btn-sm px-2" data-toggle="tooltip" data-placement="top" title="Back to Announcement list"><i class="fa fa-chevron-left mt-0"></i></a>
                        </div>
                    </div>
                    <div class="card-body">

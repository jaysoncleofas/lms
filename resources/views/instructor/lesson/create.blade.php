        ...
        <div class="col-xl-9 col-md-9 mb-4">
            ...
            <form class="" action="{{route('instructor.lesson.store', $course->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="md-form mb-3">
                    ...
                    <textarea name="description" id="description" class="md-textarea form-control pt-0 {{$errors->has('description') ? 'is-invalid' : ''}}" rows="8" cols="80">{{old('title')}}</textarea>
                ...
                <div class="md-form">
                    ...
                    <div class="file-field">
                        ...
                        <div class="file-path-wrapper pr-3">
                            <input class="file-path {{$errors->has('upload_file') ? 'is-invalid' : ''}}" type="text" name="upload_file" id="upload_file" placeholder="Upload file" readonly>
                        </div>
                    </div>

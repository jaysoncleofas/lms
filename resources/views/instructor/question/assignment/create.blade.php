    ...
    <div class="row justify-content-center mt-5">
        <div class="col-xl-9 col-md-9 mb-4">
            ...
            <form class="" action="{{route('instructor.question.assignmentStore', [$course->id, $assignment->id])}}" method="post"
                ...
                <div class="md-form">
                    <input type="text" name="question" id="question" value="{{old('question')}}" class="form-control {{$errors->has('question') ? 'is-invalid' : ''}}">
                ...
                <div class="md-form">
                    ...
                    <div class="file-field">
                        ...
                        <div class="file-path-wrapper pr-3">
                            <input class="file-path" name="image" type="text" placeholder="Upload question image" readonly>
                        </div>
                    </div>
                ...
                <div class="md-form">
                    <input type="text" id="option_one" name="option_one" value="{{old('option_one')}}" class="form-control">

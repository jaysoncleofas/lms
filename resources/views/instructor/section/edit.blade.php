            ...
            <div class="col-xl-6 col-md-6 mb-5 pb-5">
                <div class="card card-cascade narrower z-depth-1">
                    <div class="view gradient-card-header indigo narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                            <a class="white-text mx-3">Update Section</a>
                        <div>
                            <a href="{{route('instructor.section.index', $course->id)}}" class="btn btn-outline-white btn-rounded btn-sm px-2"><i class="fa fa-chevron-circle-left mt-0"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('instructor.section.update', [$course->id, $section->id])}}" method="post">
                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    <div class="md-form">
                                        <input type="text" name="name" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" value="{{$section->name}}">

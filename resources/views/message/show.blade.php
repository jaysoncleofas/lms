                                ...
                                <div class="">
                                    ...
                                    <div class="text-center"><small>{{$message->created_at->toDayDateTimeString()}}</small></div>
                                        ...
                                        <div class="d-flex justify-content-start media">
                                            <!-- Avatar -->
                                            <img class="img-fluid rounded-circle z-depth-1 mr-2" style="height:50px;width:50px;" src="{{$message->user->avatar ? asset('storage/avatars/'.$message->user->avatar) : asset('images/profile_pic.png')}}">

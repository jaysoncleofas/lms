            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="mdb-feed">
                        <div class="news">
                            <div class="label">
                                <img src="{{$announcement->instructor->avatar ? asset('storage/avatars/'.$announcement->instructor->avatar) : asset('images/profile_pic.png')}}"
                                    style="height:40px;width:40px;" class="rounded-circle z-depth-1-half">
                            </div>
                            <div class="excerpt">
                                <div class="brief">
